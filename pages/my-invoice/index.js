...
<div className="mx-auto shadow-xl w-4/5" style={{"margin-top": "-100px"}}>
    <div className="w-full bg-gray-200 p-6 text-center">
        <h2 className="text-xl font-bold">To confirm your order, contact us on WhatsApp by clicking on the button below {invoice.client_fname}!</h2>
    ...
    <div className="w-full flex justify-start flex-wrap items-start">
       <div className='border-l border-gray-200 p-2'>
        <h2 className="text-xl font-bold">رقم الطلب:</h2>
        <p className="font-Roboto mt-4">{invoice.id}</p>
       </div>
       <div className='border-l border-gray-200 p-2'>
        <h2 className="text-xl font-bold">التاريخ:</h2>
        <p className="font-Roboto mt-4">{invoice.created_at}</p>
       </div>
       <div className='border-l border-gray-200 p-2'>
        <h2 className="text-xl font-bold">الإجمالي:</h2>
        <p className="font-Roboto mt-4">{invoice.grandtotal}</p>
       </div>
       <div className='p-2'>
        <h2 className="text-xl font-bold">وسيلة الدفع:</h2>
        <p className="font-Roboto mt-4">{invoice.payment_methode}</p>
       </div>
    </div>
    <div className="w-full px-6 py-4">
        <div className="pt-12 md:pt-0 2xl:ps-4">
            <h2 className="text-xl font-bold bg-gray-200 px-2 py-4 border border-gray-300">تفاصيل الطلب</h2>
